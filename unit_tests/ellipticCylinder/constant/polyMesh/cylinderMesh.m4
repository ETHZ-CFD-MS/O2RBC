...
define(vlabel, [[// ]Vertex $1 = VCOUNT define($1, VCOUNT)define([VCOUNT], incr(VCOUNT))])
    ...
    define(RO,  calc(0.5*D)) // cylinder inner radius
    ...
    define(NS,  10) // number of cells in the square section
    define(NPI,  5) // number of cells from square section to inner perimeter
    define(NPO,  5) // number of cells from inner to outer perimeter
    define(NX,   1) // number of cells from left to right
