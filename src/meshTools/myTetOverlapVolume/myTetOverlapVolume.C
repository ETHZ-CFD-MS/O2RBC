...
namespace Foam
{
defineTypeNameAndDebug(myTetOverlapVolume, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::myTetOverlapVolume::myTetOverlapVolume()
{}


// * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * * //

Foam::scalar Foam::myTetOverlapVolume::tetTetOverlapVol
(
...
) const
{
    ...
    if ((tetA.tet().mag() < VSMALL) || (tetB.tet().mag() < VSMALL))
    {
        return 0.0;
    }
...
Foam::treeBoundBox Foam::myTetOverlapVolume::pyrBb
(
...
bool Foam::myTetOverlapVolume::cellCellOverlapMinDecomp
(
...
Foam::scalar Foam::myTetOverlapVolume::cellCellOverlapVolumeMinDecomp
(
    const primitiveMesh& meshA,
    const label cellAI,
...
Foam::labelList Foam::myTetOverlapVolume::overlappingCells
(
