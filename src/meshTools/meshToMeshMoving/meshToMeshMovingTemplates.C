...
template<class Type>
void Foam::meshToMeshMoving::add
(
    UList<Type>& fld,
    const label offset
) const
...
void Foam::meshToMeshMoving::mapSrcToTgt
(
    const UList<Type>& srcField,
    const CombineOp& cop,
    List<Type>& result,
    const bool weighTgtFld
) const
{
...
template<class Type, class CombineOp>
Foam::tmp<Foam::Field<Type> > Foam::meshToMeshMoving::mapSrcToTgt
(
...
template<class Type, class CombineOp>
void Foam::meshToMeshMoving::mapTgtToSrc
(
    const UList<Type>& tgtField,
    const CombineOp& cop,
    List<Type>& result,
    const bool weighSrcFld
) const
{
...
template<class Type, class CombineOp>
Foam::tmp<Foam::Field<Type> > Foam::meshToMeshMoving::mapTgtToSrc
(
...
Foam::meshToMeshMoving::mapSrcToTgt
(
    const GeometricField<Type, fvPatchField, volMesh>& field,
    const CombineOp& cop
) const
...
template<class Type, class CombineOp>
Foam::tmp<Foam::GeometricField<Type, Foam::fvPatchField, Foam::volMesh> >
Foam::meshToMeshMoving::mapTgtToSrc
(
    const GeometricField<Type, fvPatchField, volMesh>& field,
    const CombineOp& cop
) const
