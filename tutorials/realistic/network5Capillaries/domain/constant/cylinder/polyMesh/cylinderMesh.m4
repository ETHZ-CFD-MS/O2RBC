...
define(VCOUNT, 0)
define(vlabel, [[// ]Vertex $1 = VCOUNT 
define($1, VCOUNT)define([VCOUNT], incr(VCOUNT))])
    ...
    define(NS,   4) // number of cells in the square section
    ...
    define(NX,  30) // number of cells from left to right
